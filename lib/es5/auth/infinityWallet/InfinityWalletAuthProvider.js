...
const InfinityWalletAuthProvider = (props) => {
    ...
    const login = (0, use_custom_compare_1.useCustomCompareCallback)(async () => {
        try {
            ...
            const principal = await infinityWalletHelper_1.InfinityWalletHelper.login(props.whitelist, props.host);
    ...
    }, [props.whitelist, props.host], lodash_1.default.isEqual);
    const logout = (0, react_1.useCallback)(async () => {
        await infinityWalletHelper_1.InfinityWalletHelper.logout();
        (0, react_dom_1.unstable_batchedUpdates)(() => {
            authSourceProviderContext.setSource(undefined);
    ...
    const createActor = (0, use_custom_compare_1.useCustomCompareCallback)(async function (canisterId, idlFactory, options) {
        ...
        const createActorResult = await infinityWalletHelper_1.InfinityWalletHelper.createActor(canisterId, idlFactory, (_a = options === null || options === void 0 ? void 0 : options.agentOptions) === null || _a === void 0 ? void 0 : _a.host);
        ...
        (async () => {
            try {
                if (authSourceProviderContext.source == "InfinityWallet") {
                    ...
                    const principal = await (0, geekfactory_js_util_1.promiseWithTimeout)(infinityWalletHelper_1.InfinityWalletHelper.getLoggedInPrincipal(props.whitelist, props.host), timeoutMillis, new Error(`InfinityWalletHelper.getLoggedInPrincipal timed out in ${timeoutMillis}ms!`));
