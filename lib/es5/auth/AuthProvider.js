...
const AuthProvider = (props) => {
    ...
    const nfidInternetIdentityAuthProviderContext = (0, NFIDAuthProvider_1.useNFIDAuthProviderContext)();
    ...
    (0, react_1.useEffect)(() => {
        console.log("AuthProvider: useEffect[login]: login changed", login);
    }, [login]);
