...
function createActorGeneric(canisterId, idlFactory, options, agent_) {
    const agent = agent_ !== null && agent_ !== void 0 ? agent_ : new agent_1.HttpAgent({ ...options === null || options === void 0 ? void 0 : options.agentOptions });
