...
const login = (parameters) => {
    ...
    return new Promise((resolve, reject) => {
        ...
        return authClient.login({
            ...
            maxTimeToLive: maxTimeToLiveNanos !== null && maxTimeToLiveNanos !== void 0 ? maxTimeToLiveNanos : BigInt(exports.TTL),
